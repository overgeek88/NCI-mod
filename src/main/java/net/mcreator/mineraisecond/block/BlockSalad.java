...
import net.mcreator.mineraisecond.item.ItemSalade;
...
public class BlockSalad extends ElementsClubInfoMod.ModElement {
	@GameRegistry.ObjectHolder("club_info:salad")
	public static final Block block = null;
	public BlockSalad(ElementsClubInfoMod instance) {
		super(instance, 73);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("club_info:salad", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemSalade.block, (int) (1)));
		}
