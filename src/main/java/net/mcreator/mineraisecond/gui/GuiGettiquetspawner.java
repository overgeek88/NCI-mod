...
package net.mcreator.mineraisecond.gui;
...
public class GuiGettiquetspawner extends ElementsClubInfoMod.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiGettiquetspawner(ElementsClubInfoMod instance) {
		super(instance, 467);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				ClubInfoMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("club_info:textures/gettiquetspawner.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("selectionne l'oeuf pour le spawner", 2, 3, -12829636);
		}
		...
		protected void actionPerformed(GuiButton button) {
			ClubInfoMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
