...
public class ProcedureUraniumSwordToolInInventoryTick extends ElementsClubInfoMod.ModElement {
	public ProcedureUraniumSwordToolInInventoryTick(ElementsClubInfoMod instance) {
		super(instance, 444);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure UraniumSwordToolInInventoryTick!");
			return;
		}
