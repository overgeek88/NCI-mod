...
public class ProcedureUraniumShovelToolInInventoryTick extends ElementsClubInfoMod.ModElement {
	public ProcedureUraniumShovelToolInInventoryTick(ElementsClubInfoMod instance) {
		super(instance, 445);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure UraniumShovelToolInInventoryTick!");
			return;
		}
