...
public class ProcedureTNTSwordMobIsHitWithTool extends ElementsClubInfoMod.ModElement {
	public ProcedureTNTSwordMobIsHitWithTool(ElementsClubInfoMod instance) {
		super(instance, 239);
	}
