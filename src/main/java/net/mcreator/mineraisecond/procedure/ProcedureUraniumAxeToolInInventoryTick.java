...
public class ProcedureUraniumAxeToolInInventoryTick extends ElementsClubInfoMod.ModElement {
	public ProcedureUraniumAxeToolInInventoryTick(ElementsClubInfoMod instance) {
		super(instance, 443);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure UraniumAxeToolInInventoryTick!");
			return;
		}
