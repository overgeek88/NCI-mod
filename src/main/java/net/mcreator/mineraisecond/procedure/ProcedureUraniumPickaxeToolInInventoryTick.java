...
public class ProcedureUraniumPickaxeToolInInventoryTick extends ElementsClubInfoMod.ModElement {
	public ProcedureUraniumPickaxeToolInInventoryTick(ElementsClubInfoMod instance) {
		super(instance, 442);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure UraniumPickaxeToolInInventoryTick!");
			return;
		}
