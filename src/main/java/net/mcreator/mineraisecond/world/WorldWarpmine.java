...
package net.mcreator.mineraisecond.world;
...
import net.mcreator.mineraisecond.item.ItemWarpmine;
...
public class WorldWarpmine extends ElementsClubInfoMod.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = true;
	@GameRegistry.ObjectHolder("club_info:warpmine_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldWarpmine(ElementsClubInfoMod instance) {
		super(instance, 373);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemWarpmine().setUnlocalizedName("warpmine").setRegistryName("warpmine"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension warpmine is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("warpmine", "_warpmine", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemWarpmine.block, 0, new ModelResourceLocation("club_info:warpmine", "inventory"));
	}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("warpmine_portal");
			setRegistryName("warpmine_portal");
			setLightLevel(0F);
		}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		private static final IBlockState STONE3 = Blocks.STONE.getStateFromMeta(0);
